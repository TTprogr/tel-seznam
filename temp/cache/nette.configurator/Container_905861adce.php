<?php
// source: C:\xampp\htdocs\nette\telefon/config/common.neon
// source: C:\xampp\htdocs\nette\telefon/config/services.neon
// source: array
...
class Container_905861adce extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\Edit\EditPresenter' => [2 => ['application.1']],
	...
	public function createServiceApplication__1(): App\UI\Edit\EditPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\nette\telefon/temp/cache/nette.application/touch',
		));
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=telefon', /*sensitive{*/'root'/*}*/, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_905861adce $container,
			) {
			}
